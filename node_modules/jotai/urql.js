...
function atomWithSubscription(createSubscriptionArgs, getClient) {
  ...
  var queryResultAtom = jotai.atom(function (get) {
    ...
    var subscription = wonka.pipe(client.subscription(args.query, args.variables, args.context), wonka.subscribe(listener));
    ...
    resultAtom.onMount = function (update) {
      ...
      return function () {
        ...
        return (_subscription2 = subscription) == null ? void 0 : _subscription2.unsubscribe();
      };
    };
